...
public class LogGenerator extends Agent {
	...
	private static final String FILE_HEADER = "caseId,taskId,Originator,Req_retrieve_Time,Resp_retrieve_Time,Req_Assign_Tim,Resp_Assign_Time,Req_exec_Time,Resp_exec_Time,Retrive_Time,Assign_Time,Exec_Time,Retrive_Exec,Ag_Time,Ready_Exec";
